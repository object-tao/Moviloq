...
import { reviewGuidanceCss } from "./ops-review-guidance";
...
export function createAdminApp() {
  ...
  app.get("/ops.css", c => c.body(opsCss + opsNavigationCss + resourceDialogCss + resourceReviewCss + reviewGuidanceCss, 200, { "Content-Type": "text/css; charset=utf-8" }));
